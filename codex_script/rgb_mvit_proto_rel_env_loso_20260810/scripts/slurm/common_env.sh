...
PACKAGE_ROOT="$PROJECT_ROOT/codex_script/rgb_mvit_proto_rel_env_loso_20260810"
PYTHON_BIN=${PYTHON_BIN:-${CONDA_PREFIX}/bin/python}
SCREEN_FOLD=${SCREEN_FOLD:-MR}
export PROJECT_ROOT DATASET_ROOT PACKAGE_ROOT PYTHON_BIN SCREEN_FOLD
