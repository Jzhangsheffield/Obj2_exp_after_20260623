...
名称来源补充：`h00/h10/h01/h11`均以历史`stage4/h2_emg_both_p1_k10`为共同模板，其中两位数字依次表示ProtoLoss/RelLoss开关。`h11`等价于原H2 Active；其余三项是为严格2×2消融新增的覆盖配置。特别是`h00_p1_k10`不是历史`hn1_null_p1`的改名，二者Top-K分别为10和3，历史`hn1`结果不能代替新`h00`结果。
