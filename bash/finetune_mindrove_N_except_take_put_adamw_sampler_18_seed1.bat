...
REM ============================================================
REM Fine-tune MindRove EMG + IMU contrastive checkpoints for N_as_test / train_manifest_except_take_put.jsonl
REM - seed=1 only
...
set "PRETRAIN_PARENT=D:\junxi_data\experiments_after_260623\results\mindrove_N_except_take_put_adamw_sampler_18"
set "OUTPUT_ROOT=D:\junxi_data\experiments_after_260623\results\ft_mindrove_N_except_take_put_adamw_sampler_18_seed1"
...
REM set "PRETRAIN_PARENT=%PROJECT_ROOT%\results\mindrove_N_except_take_put_adamw_sampler_18"
REM set "OUTPUT_ROOT=%PROJECT_ROOT%\results\ft_mindrove_N_except_take_put_adamw_sampler_18_seed1"

set "PYTHON_BIN=python"
set "CHECKPOINT_NAME=checkpoint_0200.pth"
set "EXPECTED_NUM_CKPTS_PER_SIGNAL=9"
