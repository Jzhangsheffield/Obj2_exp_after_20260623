...
REM ============================================================
REM Fine-tune MindRove EMG + IMU contrastive checkpoints for N_as_test / train_manifest_take_put.jsonl
REM - seed=1 only
...
set "PRETRAIN_PARENT=D:\junxi_data\experiments_after_260623\results\cl_mindrove_N_take_put_adamw_44"
set "OUTPUT_ROOT=D:\junxi_data\experiments_after_260623\results\ft_mindrove_N_take_put_adamw_44_seed1"
...
REM set "LABEL_MAP_JSON=%DATASET_ROOT%\label_map_take_put.json"
REM set "PRETRAIN_PARENT=%PROJECT_ROOT%\results\mindrove_N_take_put_adamw_44"
REM set "OUTPUT_ROOT=%PROJECT_ROOT%\results\ft_mindrove_N_take_put_adamw_44_seed1"

set "PYTHON_BIN=python"
set "CHECKPOINT_NAME=checkpoint_0200.pth"
set "EXPECTED_NUM_CKPTS_PER_SIGNAL=22"
...
REM ============================================================
set "TRAIN_MANIFEST=N_as_test\train_manifest_take_put.jsonl"
set "VAL_MANIFEST=N_as_test\val_manifest_take_put.jsonl"
set "TIER_MODE=tier1"
set "NUM_CLASSES=2"
...
REM Normalization parameters from N_as_test\train_normalization_stats\take_put_mindrove_stats.json; whitespace-separated for train_mapstyle_finetune_and_test.py.
...
set "PRETRAINED_TAG_ANCHOR=cl_mindrove_N_take_put_adamw_44"
...
echo ============================================================
echo MindRove finetuning: train_manifest_take_put.jsonl
