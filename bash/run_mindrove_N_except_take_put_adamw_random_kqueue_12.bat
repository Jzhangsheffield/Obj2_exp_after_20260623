...
REM ============================================================
REM MindRove EMG + IMU random-sampler K_queue ablation for N_as_test / train_manifest_except_take_put.jsonl
REM 
...
set "OUT_ROOT=%PROJECT_ROOT%\results\mindrove_N_except_take_put_adamw_random_kqueue_12"
...
set "PROJ_DIM=128"
set "K_QUEUE_VALUES=512 1024 2048"
...
echo ============================================================
echo MindRove EMG + IMU random-sampler K_queue ablation for N_as_test / train_manifest_except_take_put.jsonl
...
for %%K in (%K_QUEUE_VALUES%) do (
    call :run_one_cfg "!CUR_SIGNAL!" "contrastive_only" "" "1" "suploss_only" "%%K" "random" "%RANDOM_SAMPLER_TYPE_ARG%"
    if errorlevel 1 exit /b 1
