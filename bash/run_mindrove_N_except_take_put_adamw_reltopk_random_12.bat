...
REM ============================================================
REM MindRove EMG + IMU relative-loss top-k ablation for N_as_test / train_manifest_except_take_put.jsonl
REM 2 signals x 2 loss configs x rel_topk_diff_classes(5,10,all) = 12 runs.
...
set "OUT_ROOT=%PROJECT_ROOT%\results\mindrove_N_except_take_put_adamw_reltopk_random_12"
...
set "REL_TOPK_DIFF_CLASSES_VALUES=5 10 0"
...
echo ============================================================
echo MindRove EMG + IMU relative-loss top-k ablation for N_as_test / train_manifest_except_take_put.jsonl
...
if /I "!CUR_SIGNAL!"=="emg" (
    ...
    set "CUR_REL_RUN_PREFIX=suploss_rel_p1_prem0.5"
    set "CUR_PROTO_REL_RUN_NAME=suploss_proto_rel_p1_prem0.5"
) else if /I "!CUR_SIGNAL!"=="imu" (
    set "CUR_PROTO_REL_PREM=0.3"
    set "CUR_PROTO_REL_PROTO=2"
    set "CUR_REL_RUN_PREFIX=suploss_rel_p2_prem0.3"
...
for %%K in (%K_QUEUE_VALUES%) do (
    for %%T in (%REL_TOPK_DIFF_CLASSES_VALUES%) do (
        ...
        call :run_one_cfg "!CUR_SIGNAL!" "contrastive_rel" "!CUR_PROTO_REL_PREM!" "!CUR_PROTO_REL_PROTO!" "!CUR_REL_RUN_PREFIX!_topk!CUR_TOPK_LABEL!" "%%K" "random" "%RANDOM_SAMPLER_TYPE_ARG%" "%%T"
        if errorlevel 1 exit /b 1
