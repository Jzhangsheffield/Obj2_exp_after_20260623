...
REM ============================================================
REM Fine-tune MindRove EMG + IMU contrastive checkpoints for mindrove_N_except_take_put_adamw_stage5_reltopk_random_10
REM - seed=1 only
...
set "PRETRAIN_PARENT=%PROJECT_ROOT%\results\mindrove_N_except_take_put_adamw_stage5_reltopk_random_10"
set "OUTPUT_ROOT=%PROJECT_ROOT%\results\ft_mindrove_N_except_take_put_adamw_stage5_reltopk_random_10_seed1"
...
REM set "PRETRAIN_PARENT=%PROJECT_ROOT%\results\mindrove_N_except_take_put_adamw_stage5_reltopk_random_10"
REM set "OUTPUT_ROOT=%PROJECT_ROOT%\results\ft_mindrove_N_except_take_put_adamw_stage5_reltopk_random_10_seed1"

set "PYTHON_BIN=python"
set "CHECKPOINT_NAME=checkpoint_0200.pth"
set "EXPECTED_NUM_CKPTS_PER_SIGNAL=5"
...
set "PRETRAINED_TAG_ANCHOR=mindrove_N_except_take_put_adamw_stage5_reltopk_random_10"
