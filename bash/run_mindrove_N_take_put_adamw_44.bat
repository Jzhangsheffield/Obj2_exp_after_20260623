...
REM ============================================================
REM MindRove EMG + IMU SupLoss ablation for N_as_test / train_manifest_take_put.jsonl
...
REM ------------------------------
set "PROJECT_ROOT=D:\Junxi_data\Objective2_thermal_crimp\thermal_crimp\experiments_after_260623"
...
set "OUT_ROOT=%PROJECT_ROOT%\results\mindrove_N_take_put_adamw_44"
...
REM ------------------------------
set "ENABLE_LOSS_STAGE_SCHEDULE_ARG=1"
...
echo ============================================================
echo MindRove N_as_test take_put ablation
...
set "RUN_DIR=%OUT_ROOT%\signal_!RG_SIGNAL!\aug_!CUR_AUG_POLICY!\!RG_RUN_NAME!"
