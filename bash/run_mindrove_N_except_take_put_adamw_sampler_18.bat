...
REM ============================================================
REM MindRove EMG + IMU SupLoss + batch-sampler ablation for N_as_test / train_manifest_except_take_put.jsonl
...
set "OUT_ROOT=%PROJECT_ROOT%\results\mindrove_N_except_take_put_adamw_sampler_18"
...
echo ============================================================
echo MindRove N_as_test except_take_put batch-sampler ablation
