...
REM set "PRETRAIN_PARENT=%PROJECT_ROOT%\results\mindrove_N_except_take_put_adamw_44"
REM set "OUTPUT_ROOT=%PROJECT_ROOT%\results\ft_mindrove_N_except_take_put_adamw_44_seed1"
